...
| `docs/data-layout.md` | Runtime input, intermediate, manifest, and output paths. | Move and extend | `docs/reference/file-layout.md` | Tie paths back to `config/default.toml`; clarify generated data is not source. | `config/default.toml`, `.gitignore` |
...
| `DATA_LAYOUT.md` | Top-level exact data placement duplicated by the new reference page. | Delete after merge | `docs/reference/file-layout.md` | Keep README and config references pointed at the docs reference page. | `config/default.toml` |
